...
ONE_ONE_ONE_ONE_HTTPS_WORDS = 'https://one.one.one.one/'
...
def state_check() -> Tuple[bool, requests.Response]:
    ...
    if response.url == ONE_ONE_ONE_ONE_HTTPS or response.url == ONE_ONE_ONE_ONE_HTTPS_WORDS:
...
def main() -> None:
    ...
    username: str = 'devang21'
    password: str = 'CS685_Scraper'
